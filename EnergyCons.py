# -*- coding: utf-8 -*-
"""
Created on Mon Jul 18 22:20:44 2016
...
#        v[step + 1] = v[step] + h * acceleration(x[step])#Forward Euler Method
    
        x[step + 1] = x[step] + h * v[step] 
        v[step + 1] = v[step] + h * acceleration(x[step+1]) #Symplectic method
